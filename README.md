...
We onderzoeken waar kinderen met ASS de meeste moeite mee hebben in een klasomgeving. Welke activiteiten op school leveren het meeste problemen op en wat heeft dit als gevolg op hun resultaten en schoolervaring? Zijn de kinderen bewust van hun eigen emotie en in welke mate kunnen ze die reguleren of communiceren?
  ...
  <ins>  3.	Analyse van bestaande producten/hulpmiddelen</ins> 
...
Mens-robot interacties zijn eenvoudiger te begrijpen dan mens-mens interacties, wat ze minder complex maakt. Robots zijn duidelijker en voorspelbaarder, waardoor ze minder stress en verwarring veroorzaken bij kinderen met autisme.

  -	Fidgets 

Het is bewezen dat kinderen met autisme profiteren van fidget-toys in een educatieve omgeving. Het helpt met focus, zelfregulatie, vermindering van angst en stress. 
...
-	Niet weten hoe gevoelens aan de leerkracht over te brengen, wat leidt tot conflicten in de les
...
Na deze interviews hebben we persona’s aangemaakt voor de mensen die in contact zullen komen met dit product.

![image](https://github.com/user-attachments/assets/3a52ed0a-a823-49ea-9277-2df99b9a368e)
...
### Doestellingen
De algemene doelstelling is een helder gedefinieerd finaal ontwerpconcept. 
...
![image](https://github.com/user-attachments/assets/0148365a-e7be-486b-a790-7a975a3cad90)


Daarnaast vroegen we ook opnieuw om de emoticons in te kleuren zodat we een grotere databank hadden aan gekleurde emoticons om beter verbanden te leggen tussen de kleurassociaties. Hierbij is de kleur van de emotie vastgelegd op de kleur die het meest aan bod kwam. 
...
Omdat personen met ASS makkelijker overprikkeld geraken is het sensorische aspect van ons product heel belangrijk. Daarom hebben we ons in deze wave ook nog gefocust op het ervaren van verschillende texturen met een touch and feel bord.  Hierbij hebben we de leerling blindelings laten voelen aan de materialen en hun vragen gesteld over wat ze aangenaam vonden en minder aangenaam vonden om aan te voelen zodat we hierop het materiaal van het product kunnen baseren. We deden dit hierna ook eens opnieuw zonder het wegnemen van het visuele zintuig om zo dit zintuig een minimale tot geen invloed te geven.
...
In de enquête zullen we ook verschillende ontwerpvoorstellen doen. Enerzijds voor een overzichtscherm, waar we polsen naar de overzichtelijkheid en wat er eventueel kan toegevoegd worden.
...
### Conclusies & implicaties
Uit wave 1 concluderen we dat de emotiedraaiknop en het emotiedraairad niet geschikt waren voor het aanduiden van emoties, dit omdat we hadden opgemerkt dat de kinderen er vaak mee prutsten en ronddraaiden tijdens dat ze nadachten over het antwoord. Dit wil wel zeggen dat het ideaal is als fidgeting element op het eindconcept.
...
De casing zelf zou uit thermoplastische rubber bestaan maar is voorlopig nog ge-3D-print (stl-files te vinden in mapje BillOfMaterials)
